...
public class Debug {
   ...
   * 
   * <p>
   * By default, debug mode is enabled for development builds and disabled for exported APKs - see
   * BuildConfig.DEBUG
   * </p>
   * 
   * @param enabled
   ...
   * 
   * <p>
   * You may | (or) LOG_* constants together. Note that debug mode must also be enabled for actual logging to
   * occur.
   * </p>
   * 
   * @param type
   ...
   * 
   * <p>
   * You may | (or) LOG_* constants together, to learn if <b>all</b> passed message types are enabled for
   * logging. Note that debug mode must also be enabled for actual logging to occur.
   * </p>
   * 
   * @param type
   *          LOG_* constants
   ...
   * 
   * <p>
   * You may | (or) LOG_* constants together, to learn if <b>all</b> message types are enabled for logging.
   ...
   * 
   * <p>
   * Replaces the log method (write to logcat) with your own handler. Whether your handler gets called is
   * still dependent on debug mode and message types being enabled for logging.
   * </p>
   * 
   * @param onLogListener
   *          Custom log listener or NULL to revert to default
   */
